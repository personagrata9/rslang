...
class Main {
  render(): void {
    ...
    video.innerHTML = `<iframe class='iframe-main' width="560" height="315" src="https://www.youtube.com/embed/y82MVLECRW0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`;
    main.append(video);
